                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <form id="contactForm">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="content" id="message" placeholder="Enter your message here..." style="height: 12rem" data-sb-validations="required">${blog.content}
                                    </textarea>
                                ...
                                <a href="updateForm.do?id=${blog.id}">수정</a>
                                <a href="delete.do?id=${blog.id}">삭제</a>
                            </form>
                        </div>
                    </div>
                </div>
