            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div class="my-5">
                    ...
                    <form id="contactForm" action="post.do" method="post">
                        ...
                        <div class="form-floating">
                            <input class="form-control" name="email" id="email" type="email"  value="${sessionScope.bloggerEmail}" placeholder="Enter your email..." data-sb-validations="required,email" readonly="readonly" />
